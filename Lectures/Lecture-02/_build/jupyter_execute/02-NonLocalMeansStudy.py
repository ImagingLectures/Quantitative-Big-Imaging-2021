...
img=plt.imread('figures/boat.png')
...
- $f(p,q)$ is a weight function based on the intensity difference between the pixels $p$ and $q$ $$f(p,q)=e^{-\frac{|B(q)-B(p)|^2}{h^2}}$$
...
### Try filter effect of parameter $h$
